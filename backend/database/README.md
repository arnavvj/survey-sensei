...
embeddings vector(1536)  -- ✅ Auto-populated during data generation
```
...
```
User Input (Form) → Orchestrator → Agents → Database
                         │
...
- Example: `✅ GET /api/mock-data → 200 (1234ms)`
...
- Example: `🤖 Generating review options`
